...
7. coverageDirection 写 2-4 句,覆盖“风险如何发生、可能造成什么责任或损失、保障应关注什么”;rationale 写 2-4 句,明确绑定企业画像与触发缺口。不能从画像或证据推出的内容必须明确标注“需进一步核实”。
8. 不得用“存在相关风险、建议关注”等空泛模板代替分析;每个判断都必须能回到企业画像、触发缺口或证据。
9. keyClauses 优先给出 2-5 条责任、除外、免赔或核对事项;证据不足时宁可少写,不得补齐数量而编造。
